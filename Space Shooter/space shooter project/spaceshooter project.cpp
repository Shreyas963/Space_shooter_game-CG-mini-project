	...
	displayRasterText(-100, 150, 0.0,"created by");
	 ...
	 displayRasterText(-130, 80, 0.0,"SHOOTERS");
	  ...
	  displayRasterText(-800, -100, 0.0," STUDENT NAMES");
	  	glColor3f(1.0, 1.0, 1.0);
	displayRasterText(-800, -200, 0.0," Y SAI SANJAY");
	displayRasterText(-800, -285, 0.0," SHREYAS UGRA T V");
	displayRasterText(-800, -370, 0.0," SHREEKAR YP");
		glColor3f(1.0, 0.0, 0.0);
	displayRasterText(500, -100, 0.0,"Under the Guidance of");
		glColor3f(1.0, 1.0, 1.0);
	displayRasterText(500, -200, 0.0,"DR.USHA KIRAN");
		glColor3f(1.0, 0.0, 0.0);
